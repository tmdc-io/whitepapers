...
graph TB
    ...
    subgraph "DataOS Platform"
        subgraph "Nilus - Query Log Collector"
        ...
        subgraph "Athena Data Product"
            subgraph "Raw Signal Processing"
            ...
            subgraph "Intelligence Tables"
                ...
                OPT[Optimization Patterns Table]
    ...
    %% Styling
    classDef depot fill:#e1f5fe
    classDef nilus fill:#f3e5f5
    classDef athena fill:#e8f5e8
    classDef intelligence fill:#fff3e0
    classDef api fill:#fce4ec
    classDef consumer fill:#f1f8e9
    
    class SF,BQ,DB,PG,TR,OTHER depot
    class QLC,QLP,QLS nilus
    class RSI,QF,SE,PA,ML athena
    class QIT,UBT,OPT,ANT,SEM intelligence
    class PAPI,CAPI,SAPI,SEMAPI,COLAPI api
    class DSUI,DASH,ALERT,EXT,WORK consumer
```
